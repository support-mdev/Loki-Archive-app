...
<body class="mb-48 bg-green-950">
    <nav class="flex justify-between items-center mb-4 text-white"">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            ...
            <li>
                <a href="/listings/manage" class="hover:text-laravel"><i class="fa-solid fa-scroll"></i>
                    Manage Listings</a>
            </li>
            <li>
    ...
    <footer
        ...
        <a href="/listings/create" class="absolute top-1/3 right-10 bg-black text-white py-2 px-5">Add to Archive</a>
    </footer>
